...
description: Бұл мақала бағаны орнатуға және транзакциялық нысандарға теңшелетін өрістерді қосу туралы ақпаратты береді.
author: Rumant
ms.custom:
...
Бұл мақала мақаладағы процедураларды орындағаныңызды болжайды, [Теңшелетін өрістер мен нысандарды жасаңыз](create-custom-fields-entities.md). Егер сіз бұл процедураларды орындамаған болсаңыз, кері оралып, оларды аяқтаңыз, содан кейін осы мақалаға оралыңыз. 
