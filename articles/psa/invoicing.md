...
description: Бұл мақалада шот-фактура туралы ақпарат берілген.
author: rumant
ms.custom:
...
> [!NOTE]
> Project Service Automation пакеттік есеп-шот ұсыну есеп-шот кестелерімен реттелген жобалық келісім-шарт жолы үшін ғана жұмыс істейді. Белгіленген бағамен шот ұсыну әдісі бар келісім-шарт жолында кезеңдер теңшелген болуы керек. Уақыт пен материалдық шот ұсыну әдісі бар жобаның келісім-шарт жолы күнтізбелік есеп-шот кестесін қажет етеді. Бағалау жолына негізделген жоба контекстінде шот-фактура жиілігін орнату туралы ақпарат мақалада берілген, [Дәйексөздер мен тырнақшалар](basic-quote-lines.md#invoice-schedule). Бұл жобаға негізделген келісім-шарт жолына да қатысты.      
