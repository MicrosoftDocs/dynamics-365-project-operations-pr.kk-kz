...
description: Бұл мақалада реттелетін өрістерді ендіру үшін кеңейтімдерді пайдалануға арналған жалпы үлгілер берілген.
author: Yowelle
ms.date: 05/29/2019
ms.topic: article
ms.prod: ''
...
Бұл мақалада реттелетін өрістерді ендіру үшін кеңейтімдерді пайдалануға арналған жалпы үлгілер берілген. Келесі мақалаларда қамтылады:
...
Бұл мақала реттелетін өрістерді Apple iOS және Google Android үшін қолжетімді болатын Microsoft Dynamics 365 Project Timesheet мобильді құрылғы бағдарламасында біріктіретін әзірлеушілерге арналған. Оқырмандар X++ әзірлеуімен және жобаның уақыт кестесі функциясымен таныс деп болжанады.
