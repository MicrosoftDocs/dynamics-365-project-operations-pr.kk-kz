...
description: Бұл мақала теңшелетін өрістерді іске асыру үшін кеңейтімдерді пайдаланудың жалпы үлгілерін ұсынады.
author: Yowelle
ms.date: 05/29/2019
ms.topic: article
ms.prod: ''
...
Бұл мақала теңшелетін өрістерді іске асыру үшін кеңейтімдерді пайдаланудың жалпы үлгілерін ұсынады. Келесі мақалалар қамтылған:
...
Бұл мақала пайдаланушы өрістерін біріктіретін әзірлеушілерге арналған Microsoft Dynamics 365 Project Timesheet Apple iOS және Google үшін қол жетімді мобильді қосымша Android. Оқырмандар X++ әзірлеуімен және жобаның уақыт кестесі функциясымен таныс деп болжанады.
...
- **stringOptions** сипаты **TSTimesheetCustomField** нысанында берілсе, осы тізім элементтері пайдаланушылар ажыратпа-қосқыштар (радио түймешіктер) көмегімен таңдай алатын мәндер болып табылады.
    ...
    Бұл жағдайда жол өрісі пайдаланушы жазбасының мақсатында бағалау өрісі ретінде әрекет етеді. Мәнді дерекқорға санау ретінде сақтау үшін пәрмендер тізбегін пайдалану арқылы дерекқорға сақтамас бұрын жол мәнін тізімдік мәнге қолмен салыстырыңыз ("Тесті кесте жазбасын сақтау үшін TSTimesheetEntryService сыныбында пәрмендер тізбегін пайдалану" бөлімін қараңыз. Мысал үшін осы мақаланың кейініректегі қолданбаны дерекқорға қайтару» бөлімі).
