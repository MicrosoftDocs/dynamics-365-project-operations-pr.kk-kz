---
title: Жоба тапсырмаларын тікелей Project Service Automation қолданбасынан Қаржы және Операцияларға синхрондаңыз
description: Бұл тақырып жоба тапсырмаларын тікелей синхрондау үшін пайдаланылатын үлгіні және негізгі тапсырманы сипаттайды Microsoft Dynamics 365 Project Service Automation Dynamics 365 Finance.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8683317"
---
# <a name="synchronize-project-tasks-directly-from-project-service-automation-to-finance-and-operations"></a>Жоба тапсырмаларын тікелей Project Service Automation қолданбасынан Қаржы және Операцияларға синхрондаңыз

[!include[banner](../includes/banner.md)]

Бұл тақырып жоба тапсырмаларын тікелей синхрондау үшін пайдаланылатын үлгіні және негізгі тапсырманы сипаттайды Dynamics 365 Project Service Automation Dynamics 365 Finance сайтына.
...
Қолдану керек болса Power Query, мына нұсқаулықты орындаңыз:
