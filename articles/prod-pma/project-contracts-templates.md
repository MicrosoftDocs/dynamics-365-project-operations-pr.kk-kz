...
Microsoft қолданбасын пайдаланыңыз Power Query Келесі шарттар орындалса, Excel деректерін сүзу үшін:
...
Қолдану керек болса Power Query, мына нұсқауларды орындаңыз:
