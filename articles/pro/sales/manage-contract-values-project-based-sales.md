---
title: Жобаның келісімшарт желілеріне шолу
description: Бұл мақалада Жоба операцияларында жоба келісім-шарттарымен жұмыс істеу туралы ақпарат берілген.
author: rumant
ms.date: 10/28/2020
ms.topic: overview
...
ms.locfileid: "9824633"
---
# <a name="project-contract-lines-overview"></a>Жобаның келісімшарт желілеріне шолу
