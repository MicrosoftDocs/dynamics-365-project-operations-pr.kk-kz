---
title: Жобаның келісімшарт сызығын бағалаңыз
description: Бұл мақалада жобаға негізделген келісім-шарт жолын есептеу туралы ақпарат берілген.
author: rumant
ms.date: 03/30/2021
ms.topic: article
...
ms.locfileid: "9824774"
---
# <a name="estimate-a-project-contract-line"></a>Жобалық келісім-шарт жолын болжау

_**Қолданылады:** қарапайым орналастыру - проформа-шотын ұсыну мәмілесі_

 Dynamics 365 Project Operations-де жобаның келісім-шарт жолында келісімшарт желісін жеткізуге тартылатын жұмыстың құны мен ықтимал кірісін бағалауға көмектесетін мәліметтер бар.

Жобаның келісім-шарт сызығын бағалау үшін жоба негізіндегі **Келісім-шарт сызығындағы** Келісімшарт сызығының мәліметтері **қойындысына өтіңіз**.  Жоба негізіндегі келісім-шарт жолы бойынша есепті жасаудың екі әдісі бар:
...
Тікелей жобаның келісімшарт жолында бағалауды жасау үшін мына қадамдарды орындаңыз:
