---
title: Жобаның келісім-шарт жолында шот-фактура кестелерін жасаңыз
...
ms.locfileid: "9824727"
---
# <a name="create-invoice-schedules-on-a-project-contract-line"></a>Жобаның келісім-шарт жолында шот-фактура кестелерін жасаңыз
