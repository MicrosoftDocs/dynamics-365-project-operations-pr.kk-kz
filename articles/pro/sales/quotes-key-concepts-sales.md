---
title: Жоба ұсынысының бірегей тұжырымдамалары
description: Бұл мақалада Project Operations бағдарламасындағы жобаның баға ұсынуын пайдалану туралы ақпарат берілген.
author: rumant
ms.date: 10/01/2020
ms.topic: article
...
- Сату бағалары сатылым бағасына бірнеше тапсырыстарды тіркеуге мүмкіндік береді. Жобалық операцияларда жобаның баға ұсынысына тек бір жоба келісімшартын қосуға болады.
...
- Сатылым бағасы жоба бағасына енгізілген кейбір өрістер мен тұжырымдамаларды қамтымайды. Өрістерге мыналар кіреді: **Келісім-шарт бірлігі**, **Тіркелгі менеджері** және **Есепшот ұсынылатын контактінің аты**.  
