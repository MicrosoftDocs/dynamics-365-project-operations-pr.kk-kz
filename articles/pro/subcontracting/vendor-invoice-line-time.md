---
title: Уақыт бойынша жеткізушінің шот-фактура желілері
description: Бұл тақырып қосалқы мердігерлер енгізген уақыт шығындары үшін жеткізушінің шот-фактура жолдарын қалай жазу керектігін түсіндіреді.
author: rumant
ms.date: 03/15/2022
ms.topic: article
...
ms.locfileid: "8597207"
---
# <a name="vendor-invoice-lines-for-time"></a>Уақыт бойынша жеткізушінің шот-фактура желілері
