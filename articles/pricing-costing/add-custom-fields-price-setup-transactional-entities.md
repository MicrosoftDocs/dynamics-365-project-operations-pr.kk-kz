...
description: Бұл мақалада нысандарға және пішіндер мен көріністерге қажетті теңшелетін өріс сілтемелерін қосу жолы туралы ақпарат берілген.
author: rumant
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
...
---
# <a name="add-required-custom-fields-to-price-setup-and-transactional-entities"></a>Баға параметрлері мен транзакциялық нысандарға қажет реттелетін өрістерді қосу

_**Келесіге қолданылады:** ресурс/биржадан тыс негіздегі сценарийлерге арналған Project Operations, жеңілдетілген орналастыру - проформа-шотын ұсыну мәмілесі_

Бұл мақала мақаладағы процедураларды орындағаныңызды болжайды, [Баға өлшемдері ретінде пайдаланылатын теңшелетін өрістер мен нысандарды жасаңыз](create-custom-fields-entities-pricing-dimensions.md). Егер сіз бұл процедураларды орындамаған болсаңыз, кері оралып, оларды аяқтаңыз, содан кейін осы мақалаға оралыңыз. 

Бұл мақалада процедуралар нысандарға және пішіндер мен көріністер сияқты пайдаланушы интерфейсі (UI) элементтеріне қажетті пайдаланушы өріс сілтемелерін қосу жолын көрсетеді.
...
Егер реттелетін бағалау өлшемі параметр жиынтығына негізделген кезде, оны негізгі нысандарға өріс ретінде қосыңыз. Келесі процедурада **Ресурстың жұмыс орны** және **Ресурстың жұмыс сағаттары** параметрлер жиыны негізіндегі баға өлшемдері ретінде пайдаланылады. Алдымен олар баға нысандарына өріс ретінде қосылуы керек, **Рөл бағасы** және **Рөлдің үстеме бағасы**.

1. Project Operations бағдарламасында, **Параметрлер** > **Шешімдер** тармағын таңдап, **\<your organization name> бағалау өлшемдері** түймешігін басыңыз. 
...
4. **Ресурс жұмыс орны** атты жаңа өріс жасау үшін **Жаңа** пәрменін таңдаңыз және өріс түрі ретінде **Параметр жиыны** түймешігін таңдаңыз. 
5. **Бұрыннан бар параметр жиынын пайдалану** пәрменін, **Ресурстың жұмыс орны** параметр жиынын, содан кейін **Сақтау** түймешігін таңдаңыз.
...
Жобаны сату және бағалау кезеңдерінде, **Тұрақты сағаттар** және **Үстеме жұмыс уақыты** ішіндегі **Жергілікті** және **Ішкі** жұмысын аяқтау үшін қажет жұмыс қарқындылығының болжамдары, баға ұсыну/жоба мәнін бағалау үшін қолданылады. **Ресурстың жұмыс орны** және **Ресурстың жұмыс уақыты** өрістері бағалау нысандарына қосылады, **Баға ұсыну жолының мәліметі**, **Келісім-шарт жолының мәліметі**, **Жоба тобының мүшесі** және **Болжам жолы**.

1. Project Operations бағдарламасында, **Параметрлер** > **Шешімдер** тармағын таңдап, **\<your organization name> бағалау өлшемдері** түймешігін екі рет басыңыз. 
...
4. **Ресурс жұмыс орны** атты жаңа өріс жасау үшін **Жаңа** пәрменін таңдаңыз және **Параметр жиыны** өріс түрін таңдаңыз. 
5. **Бұрыннан бар параметр жиынын пайдалану** пәрменін, **Ресурс жұмыс орны**, содан кейін **Сақтау** түймешігін таңдаңыз.
6. Осы өрісті **Жоба келісім-шартының жолы туралы мәлімет**, **Жоба тобының мүшесі** және **Болжам жолы** нысандарына қосу үшін 1 - 5 қадамдарды қайталаңыз.
...
4. **Жаңа** түймешігін **Тапсырыс беруге болатын ресурс үшін стандартты тақырып** деп аталатын жаңа 1:N қатынасын жасау үшін таңдаңыз. Қажет ақпаратты енгізіп, **Сақтау** пәрменін таңдаңыз.

> ![Стандартты тақырыпты резервтеу үшін қолжетімді ресурсқа сілтеме өріс ретінде қосу.](media/ST-BR.png)

Стандартты тақырыпты сонымен қоса **Рөл бағасы** және **Рөлдің үстеме бағасы** бағалау нысандарына қосу керек болады. Бұл сонымен қатар **Стандартты тақырып** және **Рөл бағасы** нысандары және **Стандартты тақырып** және **Рөл бағасын белгілеу** нысандары арасындағы 1:N қатынастарын қолдана отырып орындалады.
...
3. **Жаңа** түймешігін **Рөл бағасы үшін стандартты тақырып** деп аталатын жаңа 1:N қатынасын жасау үшін таңдаңыз. Қажет ақпаратты енгізіп, **Сақтау** пәрменін таңдаңыз.
4. **Стандартты тақырып** және **Рөл бағасын белгілеу** нысандары арасындағы 1:N қатынастарын құру үшін 1 - 4 қадамдарды қайталаңыз.

Баға ұсынуды/Жобаны бағалау үшін жобаны сату және бағалау кезеңдерінде әрбір стандартты тақырып үшін жұмыс қарқындылығының болжамдары талап етіледі. Бұл стандартты тақырыптан осы бағалау нысандарының әрқайсысына 1:N қатынастары қажет дегенді білдіреді: 
...
5. **Стандартты тақырып** және **Баға ұсыну жолының мәліметі**, **Жоба келісім-шартының жолы туралы мәлімет**, **Жоба тобының мүшесі** және **Болжам жолы** арасында 1:N қатынастарын құру үшін 1 - 5 қадамдарды қайталаңыз.
...
1. Шешім жетектеушісіндегі сол жақ шарлау аумағында **Нысандар > Стандартты тақырып** тармағын таңдаңыз.
2. **Стандартты тақырып** нысанын кеңейтіп, **1:N қатынастары** опциясын таңдаңыз.
3. **Резервтеу үшін қолжетімді ресурс және уақыт жазбасы** параметрін екі рет басыңыз. **Қатынас** бетінде **Өрісті салыстыруларды пайдалану** пәрменін таңдаңыз. 
4. **Тапсырыс беруге болатын ресурс** нысанындағы **Стандартты тақырып** өрісі мен **Уақыт жазбасы** нысанындағы **Стандартты тақырып** сілтеме өрісі арасындағы жаңа өрісті салыстыру мүмкіндігін жасау үшін **Жаңа** түймешігін таңдаңыз. 
...
2. Егер көріністі өңдеп жатсаңыз, оң жақ шарлау аумағын пайдаланып, **Өрістер қосу** пәрменін таңдаңыз және **Өрістер тізімі** диалогтық терезесінде қажет өрісті таңдап, **Ok** түймешігін басыңыз.
...
| Entity        | Жаңа өрісті қажет ететін формалар   |Жаңа өрісті қажет ететін көріністер      |
| ------------------------------|---------------------------------|----------------------------------|
