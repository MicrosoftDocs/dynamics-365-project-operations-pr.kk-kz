...
description: Бұл мақалада жобаларға қатысты мүмкіндіктермен жұмыс істеу жолы туралы ақпарат берілген.
author: rumant
ms.date: 10/21/2020
ms.topic: article
...
Dynamics 365 Project Operations бағдарламасындағы жобаға негізделген мүмкіндіктер Dynamics 365 Sales кеңейтімдерімен жасалған. Мақалада жобаға негізделген мүмкіндіктерді басқару үшін жобаға негізделген компаниялар талап ететін қосымша функционалдылыққа кіретін әртүрлі өрістер мен бизнес логикасы туралы мәліметтер берілген.
