...
description: Бұл мақала Шығындарды басқарудағы жалпы әрекетті басқаратын параметрлерді сипаттайды.
author: suvaidya
ms.date: 10/01/2020
ms.topic: article
...
Бұл мақала Шығындарды басқарудағы жалпы әрекетті басқару параметрлерін сипаттайды.
