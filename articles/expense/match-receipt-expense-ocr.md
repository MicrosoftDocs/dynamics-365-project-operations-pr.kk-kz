...
Осы қосымша шығыс мүмкіндіктерін пайдалану үшін Microsoft Dynamics 365 Finance үшін Шығындарды басқару қызметі қондырмасын орнатып, данада мүмкіндіктерді қосыңыз. Қосымшаға жобаңыздан Microsoft Dynamics Lifecycle Services (LCS) ішінде қол жеткізе аласыз.
...
- Түбіртектер Microsoft Azure когнитивтік қызметтері арқылы өңделеді және метадеректер шығарылады және қосылады.
