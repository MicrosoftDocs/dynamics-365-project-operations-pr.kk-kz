...
description: Осы мақалада түбіртектер бойынша таңбаларды оптикалық түрде тану (OCR) өңдеуі туралы ақпарат берілген.
author: suvaidya
ms.date: 11/10/2021
ms.topic: article
ms.prod: ''
...
Осы кеңейтілген шығыс мүмкіндіктерін пайдалану үшін Microsoft Dynamics 365 Finance бағдарламасына арналған шығысты басқару қызметі қондырмасын орнатыңыз және сіздің данаңыздағы функцияларды қосыңыз. Microsoft Dynamics өмірлік цикл қызметтері (LCS) жүйесінде жобаңыздан қондырмаға кіруге болады.
...
Бұл функцияның әртүрлі аймақтарда қолжетімділігі келесі кестеде берілген. Аймағыңызға қазір қолдау көрсетілмесе, аймағыңыздағы OCR қызметінің қолжетімділігіне басымдық беру үшін сұрау жіберіңіз. 
...
| Австралия    | Иә                               |
| Еуропалық Одақ     | Жартылай. Тек ағылшын тіліндегі түбіртектер. |
| Азия   | No                                |
| Жапония  | No                                |
| Африка | No                                |
