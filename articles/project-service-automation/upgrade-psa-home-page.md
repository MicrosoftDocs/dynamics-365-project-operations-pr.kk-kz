...
2020 жылдың 1-наурызынан бастап Dynamics PSA тұтынушылары бұдан әрі PSA жүйесінің 2.х немесе одан төменгі нұсқалары секілді PSA жүйесінің ескі нұсқаларымен жаңа орталар жасай алмайды. Кез-келген жаңа ортада тек PSA жүйесінің 3.x нұсқасы болады.

> [!NOTE]
> Field Service және PSA қосымшаларының ескі нұсқаларының бар мүмкіндіктерін пайдалану үшін **Жүйе параметрлері** бетіне өтіңіз және **Жаңа бірыңғай интерфейсті ғана пайдалану (ұсынылған)** өрісі үшін **Жоқ** параметрін таңдаңыз, өйткені бұл нұсқалар UCI ішіне дұрыс жүктелмейді. UCI интерфейсін өшіргеннен кейін, осы Field Service және PSA нұсқаларын ескі веб-клиенттің көмегімен ашуға және іске қосуға болады. UCI клиентін өшіру жолы туралы нұсқауларды [Тек бірыңғай интерфейсті қосу](../admin/enable-unified-interface-only.md) бөлімінен қараңыз.
