...
description: Бұл мақалада жеткізушілерді сақтауды орнату жолы түсіндірілген.
author: sigitac
ms.date: 09/27/2021
ms.topic: article
ms.prod: ''
...
Бұл мақалада жеткізушілерді сақтауды орнату туралы ақпарат берілген.

## <a name="set-up-a-vendor-retention-account-in-general-ledger"></a>Жалпы кітапта жеткізушілерді сақтау шотын орнату

1. Dynamics 365 Finance бағдарламасында **Жалпы кітап** > **Орналастыруды жариялау** > **Автоматты транзакция шоттары** тармағына өтіңіз.
2. Жаңа жол қосыңыз.
