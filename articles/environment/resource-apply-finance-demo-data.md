...
description: Бұл мақала Dynamics 365 Finance бұлтта орналастырылған ортаға Жоба операцияларынан демонстрациялық деректерді қалай қолдану керектігін түсіндіреді.
author: sigitac
ms.date: 10/01/2020
ms.topic: article
