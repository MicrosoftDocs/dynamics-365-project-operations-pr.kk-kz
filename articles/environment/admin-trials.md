...
description: Бұл мақалада Dynamics 365 Project Operations сынақ нұсқасын қолдану жолы туралы ақпарат берілген.
author: ruhercul
ms.date: 01/10/2022
ms.topic: article
...
Бұл мақалада алдын ала қарау нұсқасының серіктестік ұсыныса жазылу және Dynamics 365 Project Operations ортасын қолдану жолдары түсіндіріледі.

Жаңа Project Operations сынақ нұсқасымен сіз орналастырудың ең жақсы тәсілін ұсынатын сауалнаманы толтыру арқылы қолдау көрсетілетін үш сценарийдің кез келгенін автоматты түрде орналастыра аласыз. Бұл мақалада төмендегілер туралы ақпарат берілген:
...
4.  Орналастыруды тексеру үшін тиісті Microsoft Dataverse URL мекенжайын, сондай-ақ қаржы және операцияларға арналған бағдарламалардың URL мекенжайларын таңдаңыз.

## <a name="configuring-dual-write"></a>Қос жазуды конфигурациялау
- Қосарлы жазудың қауіпсіздік рөлдерін конфигурациялау үшін мына бөлімді қараңыз: [Dataverse ішінде Project Operations қауіпсіздік параметрлерін жаңарту](resource-provision-new-environment.md#update-security-settings-on-project-operations-on-dataverse).
- Қосарлы жазу конфигурациясына қатынасу үшін қаржы және операциялар данасына өтіңіз, содан кейін **Деректерді басқару** > **Қосарлы жазу** тармағына өтіңіз.
- Қос жазу салыстыруын конфигурациялау үшін мына бөлімді қараңыз: [Project Operations қос жазу салыстыруларын іске қосу](resource-provision-new-environment.md#run-project-operations-dual-write-maps).
...
1. Пайдаланушыларға лицензиялар тағайындау үшін [Microsoft 365 басқару орталығы](https://portal.office.com/) бөліміне өтіңіз.
...
### <a name="what-if-i-require-alm-or-elm-for-my-finance-and-operations-apps-environment"></a>Егер қаржы және операцияларға арналған бағдарламалар ортасы үшін ALM немесе ELM қажет болса не істеу қажет?
...
1. **Microsoft 365 басқару орталығы** бөлімінде **Есеп-шот ұсыну** > **Өнімдеріңіз**. тармағына өтіңіз.
