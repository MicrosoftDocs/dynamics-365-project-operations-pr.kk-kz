...
description: Бұл мақалада Azure жазылымын LCS жобасына қосу жолы туралы ақпарат берілген.
author: sigitac
ms.date: 04/12/2021
ms.topic: article
...
Бұлт қызметтеріне орналастырылған орталар бұрыннан бар Azure жазылымын қолдану арқылы орналастырылуы керек. Бұл мақалада бар Azure жазылымын LCS жобасына қосу жолы түсіндіріледі. 
...
5. Растау үшін **Microsoft Azure орнату** экранында **Келесі** опциясын таңдаңыз. Осы экранда қате алсаңыз, бөлімге оралыңыз [Azure жазылымына Dynamics Deployment Services қатынасын қамтамасыз етіңіз](#provide) осы мақалада және барлық қадамдарды орындағаныңызға көз жеткізіңіз.
