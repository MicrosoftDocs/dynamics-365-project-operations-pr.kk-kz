...
description: Бұл мақалада компанияңыздың Project Operations бағдарламасының тиісті орналастыру түрін анықтауға көмектесу үшін ақпарат берілген.
author: stsporen
ms.date: 03/15/2021
ms.topic: article
...
## <a name="existing-customers-of-dynamics-365-finance-using-project-management-and-accounting"></a>Жобаларды басқару және есепті пайдаланатын бұрыннан бар Dynamics 365 Finance тұтынушылары 
