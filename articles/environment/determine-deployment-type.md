...
description: Бұл мақалада компанияңыз үшін Жоба операцияларының дұрыс орналастыру түрін анықтауға көмектесетін ақпарат берілген.
author: stsporen
ms.date: 03/15/2021
ms.topic: article
...
## <a name="existing-customers-of-dynamics-365-finance-using-project-management-and-accounting"></a>Dynamics 365 Finance жобаны басқару және есепке алу арқылы бар тұтынушылар 
