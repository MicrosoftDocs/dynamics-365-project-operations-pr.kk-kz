...
description: Бұл мақалада жобалар үшін компанияаралық есеп-шотты конфигурациялау туралы ақпарат пен мысалдар берілген.
author: sigitac
ms.date: 04/12/2021
ms.topic: article
...
1. **Заңды тұлғалар арасындағы компанияаралық есепті конфигурациялау**. Қарыз алушы және несие беруші заңды тұлғалардың әр жұбы жалпы кітапта, [Компанияаралық есеп](/dynamics365/finance/general-ledger/intercompany-accounting-setup) бетінде конфигурациялануы керек.
    ...
    1. Dynamics 365 Finance бағдарламасында  **Бас кітап** > **Жариялауды реттеу** > **Компанияаралық есеп** тармағына өтіңіз. Келесі ақпараттарды қамтитын жазба жасаңыз:
