...
description: Бұл мақалада түбіртектерге арналған оптикалық таңбаларды тану (OCR) өңдеуі туралы ақпарат берілген. Бұл мүмкіндік шығыс есептері жасалған кезде пайдаланушы тәжірибесін жақсартуға арналған Microsoft Dynamics 365 Қаржы.
author: stsporen
ms.date: 05/14/2020
ms.topic: article
ms.prod: ''
