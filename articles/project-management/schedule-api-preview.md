...
description: Бұл мақала жоба кестесінің API интерфейтерін пайдалану үшін ақпарат пен үлгілерді ұсынады.
author: sigitac
ms.date: 01/13/2022
ms.topic: article
...
| Жоба тапсырмасы мен белгі   | msdyn_projecttasktolabel    |
...
| **API**                                 | Сипаттама                                                                                                                       |
|-----------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| **msdyn_CreateProjectV1**               | Бұл API жоба құру үшін қолданылады. Жоба және әдепкі жоба контейнері дереу жасалады.                         |
| **msdyn_CreateTeamMemberV1**            | Бұл API жоба тобының мүшесін құру үшін қолданылады. Топ мүшелерінің жазбасы дереу жасалады.                                  |
| **msdyn_CreateOperationSetV1**          | Бұл API интерфейсін транзакция кезінде орындалуы керек бірнеше сұраныстарды жоспарлау үшін пайдаланылады.                                        |
| **msdyn_PssCreateV1**                   | Бұл API нысан құру үшін қолданылады. Нысан жасау операциясына қолдау көрсететін кез келген жобаны жоспарлау нысандары болуы мүмкін. |
| **msdyn_PssUpdateV1**                   | Бұл API интерфейсі нысанды жаңарту үшін қолданылады. Нысан жаңарту жұмысына қолдау көрсететін жобаны жоспарлау нысандарының кез келгені болуы мүмкін.  |
| **msdyn_PssDeleteV1**                   | Бұл API интерфейсі нысанды жою үшін қолданылады. Нысан жою операциясына қолдау көрсететін кез келген жобаны жоспарлау нысандары болуы мүмкін. |
| **msdyn_ExecuteOperationSetV1**         | Бұл API берілген операциялар жинағындағы барлық әрекетті орындау үшін қолданылады.                                                 |
| **msdyn_PssUpdateResourceAssignmentV1** | Бұл API интерфейсі ресурс тағайындау жоспарланған жұмыс контурын жаңарту үшін пайдаланылады.                                                        |
...
|-------------------------|------------|------------|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Жоба тапсырмасы            | Иә        | Иә        | Иә        | **Прогресс**, **EffortCompleted** және **EffortRemaining** өрістерін Project for the Web бағдарламасында өңдеуге болады, бірақ оларды Project Operations бағдарламасында өңдеу мүмкін емес.                                                                                                                                                                                             |
...
| Жоба белгісі           | No         | Иә        | No         | Белгі атауларын өзгертуге болады. Бұл мүмкіндік тек Project for the Web бағдарламасы үшін қолжетімді                                                                                                                                                                                                                                                                      |
| Жоба тапсырмасы мен белгі   | Иә        | No         | Иә        | Бұл мүмкіндік тек Project for the Web бағдарламасы үшін қолжетімді                                                                                                                                                                                                                                                                                                  |
| Жоба спринті          | Иә        | Иә        | Иә        | **Бастау** өрісіндегі күн **Аяқтау** өрісіндегі күннен ерте болуы тиіс. Бір жобаға арналған спринттер бір-бірімен қабаттаспайды. Бұл мүмкіндік тек Project for the Web бағдарламасы үшін қолжетімді                                                                                                                                                                    |
...
-   Жоба кестесінің API интерфейстерін **Microsoft Project лицензиясы бар пайдаланушылар** ғана пайдалана алады. Оларды пайдалана алмайды:
...
-   Әрбір жаңарту ресурсын тағайындау контурының жұмысы бір жұмыс ретінде есептеледі.
-   Жаңартылған контурлардың әрбір тізімі ең көбі 100 уақыт аралығын қамтуы мүмкін.
...
-   Белгілер қазір тек Project for the Web бағдарламасы үшін қолжетімді.
...
**Ресурсты тағайындау контурларын өңдеу**

Нысанды жаңартатын барлық басқа жобаны жоспарлау API интерфейстеріне қарағанда, ресурс тағайындау контурының API интерфейсі бір өрістегі msdyn_plannedwork, бір нысанда msydn_resourceassignment жаңартуларына жауапты.

Берілген кесте режимі:

-   **бекітілген бірліктер**
-   жоба күнтізбесі кешкі 9-дан 5-ке дейін шығыс уақыты бойынша кешкі 9-дан 5-ке дейін, дүйсенбі, сейсенбі, бейсенбі, жұма (СӘРСЕНБІ КҮНІ ЖҰМЫС ЖОҚ)
-   және ресурс күнтізбесі дүйсенбі мен жұма аралығында шығыс уақыты бойынша таңғы 9-дан 1-ге дейін

Бұл тапсырма бір аптаға, күніне төрт сағат уақытқа арналған. Себебі ресурс күнтізбесі шығыс уақыты бойынша таңғы 9-дан 1-ге дейін немесе күніне төрт сағат.

| &nbsp;     | Тапсырма | Басталу күні | Аяқталған күні  | Шама | 6/13/2022 | 6/14/2022 | 6/15/2022 | 6/16/2022 | 6/17/2022 |
|------------|------|------------|-----------|----------|-----------|-----------|-----------|-----------|-----------|
| 9-1 жұмысшысы |  T1  | 6/13/2022  | 6/17/2022 | 20       | 4         | 4         | 4         | 4         | 4         |

Мысалы, жұмысшының осы аптада күніне үш сағат жұмыс істеп, басқа тапсырмалар үшін бір сағат уақыт қажет болғанда.

#### <a name="updatedcontours-sample-payload"></a>UpdatedContours үлгісінің пайдалы жүктемесі:
...
Бұл жаңартуға арналған контур кестесінің API интерфейсі іске қосылғаннан кейінгі тағайындау.

| &nbsp;     | Тапсырма | Басталу күні | Аяқталған күні  | Шама | 6/13/2022 | 6/14/2022 | 6/15/2022 | 6/16/2022 | 6/17/2022 |
|------------|------|------------|-----------|----------|-----------|-----------|-----------|-----------|-----------|
| 9-1 жұмысшысы | T1   | 6/13/2022  | 6/17/2022 | 15       | 3-көше         | 3-көше         | 3-көше         | 3-көше         | 3-көше         |
