...
description: Бұл мақала Жоба кестесі API интерфейстерінің өнімділік көрсеткіштері туралы ақпарат береді және оңтайлы пайдалану үшін ең жақсы тәжірибелерді анықтайды.
author: ruhercul
ms.date: 11/03/2021
ms.topic: article
...
Бұл мақала Жоба кестесі қолданбалы бағдарламалау интерфейстерінің (API) өнімділік көрсеткіштері туралы ақпарат береді және пайдалануды оңтайландырудың ең жақсы тәжірибелерін анықтайды.
...
Жоба кестесі API интерфейстері осы мақаланың кейінгі бөлімдерінде толығырақ сипатталған сұрауларды іске қосу үшін Жобаны жоспарлау қызметіне сүйенеді.
