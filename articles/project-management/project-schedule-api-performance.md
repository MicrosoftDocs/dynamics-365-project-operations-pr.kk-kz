...
description: Бұл мақалада жоба кестесі API интерфейстерінің өнімділік көрсеткіштері туралы ақпарат берілген және оңтайлы пайдалану үшін ең жақсы тәжірибелер анықталған.
author: ruhercul
ms.date: 11/03/2021
ms.topic: article
...
Бұл мақалада жоба кестесі бағдарламасын бағдарламалау интерфейстерінің (APIs) өнімділік көрсеткіштері туралы ақпарат берілген және оңтайландырылған пайдалану үшін ең жақсы тәжірибелер анықталған.
...
Жоба кестесі API интерфейстері осы мақаланың кейінгі бөлімдерінде толығырақ сипатталған сұрауларды орындау үшін жобаны жоспарлау қызметіне сүйенеді.
