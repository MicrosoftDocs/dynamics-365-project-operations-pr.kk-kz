...
description: Бұл мақалада ресурс/биржадан тыс сценарийлерге арналған Project Operations бағдарламасының 2021 жылғы наурыз айы шығарылымындағы сапа жаңартулары туралы ақпарат берілген.
author: sigitac
ms.date: 03/03/2021
ms.topic: article
ms.prod: ''
...
- Dynamics 365 Finance бағдарламасында ортаның 10.0.16 нұсқасындағы жобаны басқару және есеп 
